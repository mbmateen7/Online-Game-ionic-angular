...
export class FilterPage implements OnInit {
        ...
        this.dragulaService
            ...
            .subscribe(({ name, el, target, source, sibling }) => {
                ...
                if (this.gameType == 'medium') {
                    const targetIndex = this.sequence1.indexOf(
                        target.className.split(' ')[0]
                    );
                    const sourceIndex = this.sequence1.indexOf(
                        source.className.split(' ')[0]
                    );
    ...
    onSendGame() {
        ...
        var finalCanvas: any = <HTMLCanvasElement>(
    ...
    changeButtons(filter) {
        ...
        if (res.length) {
            ...
            $('ion-range').attr(
                'value',
                this.secondaryValues.numbers[filter.name]
            );
            this.secondaryValues.ranges[
                this.secondaryFilterSelected
            ].sliderValue =
