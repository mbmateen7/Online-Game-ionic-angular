...
let LoginPage = class LoginPage {
    constructor(http, fb, restService, router, loadingController, alertController, userService, googlePlus, fbb, signInWithApple, platform) {
        this.http = http;
        this.fb = fb;
